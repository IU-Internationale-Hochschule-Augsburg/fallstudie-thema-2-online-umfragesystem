...
lineDiagram <- function() {
  ...
  # Speichern als PNG und direkt zurückgeben
  ggsave(filename = NULL, plot = p, device = "png")
}

png("MVP\\survey-application\\src\\main\\R\\png\\Liniendiagramm.png")
png_lineDiagram <- lineDiagram()
dev.off()
